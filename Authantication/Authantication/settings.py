...
SECRET_KEY = 'django-insecure-3(nsqgmbveyol&c6gvex&gb4!7(837xdu9b521$%c^*&mafj(x'
...
if DEBUG:
    MEDIA_URL = '/media/'
    STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "Authantication", "static", "static-only")
    MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR), "Authantication", "static", "media")
